...
const CommunityPostDetail: NextPage = () => {
  return (
    <div>
      ...
      <div>
        <div className='spacey-5 my-5 px-4'>
        ...
        <div className='px-4'>
          ...
          />
          <button className='mt-2 w-full rounded-md border border-transparent  bg-orange-500 px-3 py-2 text-sm font-medium text-white shadow-sm hover:bg-orange-600 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-offset-2'>
            Reply
          </button>
        </div>
      </div>
